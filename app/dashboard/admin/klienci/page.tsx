...
export default function AdminCustomersPage() {
    ...
    async function loadCustomers() {
        try {
            const res = await fetch("http://localhost/hurtownia-api/admin_customers.php", {
                credentials: "include",
            });
    ...
    async function deleteCustomer(customer: Customer) {
        ...
        const res = await fetch("http://localhost/hurtownia-api/admin_customer_delete.php", {
            method: "POST",
    ...
    async function updateCustomer(e: React.FormEvent) {
        ...
        const res = await fetch("http://localhost/hurtownia-api/admin_customer_update.php", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            credentials: "include",
