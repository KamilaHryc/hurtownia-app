...
export default function AdminProfilePage() {
    ...
    async function loadProfile() {
        try {
            const res = await fetch("http://localhost/hurtownia-api/profile_get.php", {
                credentials: "include",
            });
    ...
    async function updateProfile(e: React.FormEvent) {
        ...
        try {
            const res = await fetch("http://localhost/hurtownia-api/profile_update.php", {
                method: "POST",
                headers: {
    ...
    async function changePassword(e: React.FormEvent) {
        ...
        try {
            const res = await fetch("http://localhost/hurtownia-api/profile_password.php", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
