...
export default function EmployeeComplaintDetailsPage() {
    ...
    async function loadDetails() {
        try {
            const res = await fetch(
                `https://hurtownia-warzywa.42web.io/hurtownia-api/employee_complaint_details.php?id=${id}`,
                { credentials: "include" }
            );
    ...
    async function updateStatus(e: React.FormEvent) {
        ...
        const res = await fetch("https://hurtownia-warzywa.42web.io/hurtownia-api/employee_complaint_status.php", {
            method: "POST",
    ...
    return (
        <main className="min-h-screen bg-slate-100">
            <div className="flex min-h-screen">
                <Sidebar active="Reklamacje" handleLogout={handleLogout} />
